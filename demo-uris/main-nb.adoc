...
= image:images/Digdir.png[Digdir,200,200] utstillingsrom med demo permanent/persistent URI
...
Velkommen til utstillingsrommet med permanente/persistente URIer, som demonstrerer en mulig måte å implementere den norske URI-standarden! 

_https://www.digdir.no/standarder/peikarar-til-offentlege-ressursar-pa-nett/1492[Den norske URI-standarden &#x29C9;, window="_blank", role="ext-link"] (in Norwegian only) er basert på EUs https://joinup.ec.europa.eu/collection/semantic-interoperability-community-semic/document/10-rules-persistent-uris[10 Rules for Persistent URIs &#x29C9;, window="_blank", role="ext-link"]._ 
