...
Our demo classification, called link:files/demo-classifications-en#demoClassification1["Demo controlled vocabulary 1"] (in link:files/demo-classifications.ttl[RDF Turtle]), has: 

* two classification levels, link:files/demo-classifications-en#demoLev1["Demo level 1"] and link:files/demo-classifications-en#demoLev2["Demo level 2"].
** "Demo level 1" contains categories link:files/demo-classifications-en#demo-category-A["Demo category A"] and link:files/demo-classifications-en#demo-category-B["Demo category B"].
** "Demo level 2" contains link:files/demo-classifications-en#demo-category-A1["Demo category A.1"] and link:files/demo-classifications-en#demo-category-A2["Demo category A.2"].
...
** Our "Demo category A" represents, and thus also refers to, link:/showroom/skos-ap-no/files/demo-concepts-en#demoCpt1["demo concept 1"],  using the property https://data.norge.no/specification/xkos-ap-no#Kategori-referererTilBegrep[concept (dct:subject) &#x29C9;, window="_blank", role="ext-link"]. This is demonstrated in our link:/showroom/skos-ap-no/[showroom with demo concepts]. 
** Similarly, "Demo category B" represents and refers to link:/showroom/skos-ap-no/files/demo-concepts-en#demoCpt2["demo concept 2"], "Demo category A.1" represents and refers to link:/showroom/skos-ap-no/files/demo-concepts-en#demoCpt11["demo concept 11"], and "Demo category A.2" represents and refers to hlink:/showroom/skos-ap-no/files/demo-concepts-en#demoCpt12["demo concept 12"].
