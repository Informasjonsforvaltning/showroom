...
_https://informasjonsforvaltning.github.io/cpsv-ap-no/[CPSV-AP-NO &#x29C9;, window="_blank", role="ext-link"] (#under ferdigstilling#) er den norske applikasjonsprofilen av https://github.com/SEMICeu/CPSV-AP[EUs Core Public Service Vocabulary Application Profile (CPSV-AP) &#x29C9;, window="_blank", role="ext-link"], for beskrivelse av tjenester og hendelser._

[cols="10,90", grid=nome,frame=none] 
|===
| image:images/work-in-progress.png[WIP,200,200] | _Dette utstillingsrommet er under konstruksjon og vil bli ferdigstilt så snart som praktisk mulig etter ferdigstilling av CPSV-AP-NO._ 
|===
...
In this showroom we have a https://w3id.org/demo-resources/demo-services-events#exKatalog[catalog of demo services and demo events]: 
