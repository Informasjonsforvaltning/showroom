...
_https://data.norge.no/specification/cpsv-ap-no/[CPSV-AP-NO &#x29C9;, window="_blank", role="ext-link"] is the the Norwegian application profile of https://github.com/SEMICeu/CPSV-AP[EU's Core Public Service Vocabulary Application Profile (CPSV-AP) &#x29C9;, window="_blank", role="ext-link"], for describing services and events._
