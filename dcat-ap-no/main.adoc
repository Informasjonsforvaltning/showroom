...
* The distribution, with the https://data.norge.no/specification/dcat-ap-no#Distribusjon-tilgangsurl[asscess URL &#x29C9;, window="_blank", role="ext-link"] https://data.norge.no/showroom/xkos-ap-no/demo-classifications: 
