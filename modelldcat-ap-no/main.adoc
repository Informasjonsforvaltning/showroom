...
= image:/showroom/overview/images/Digdir.png[Digdir,200,200] showroom - demo information models
...
*** The code list, https://jimjyang.github.io/showroom/modelldcat-ap-no/files/demo-models-nb#demoCodelist11["Demo Code List 1"], is our "Demo classification 1" demonstrated in our link:/showroom/xkos-ap-no[showroom with demo classifications].
