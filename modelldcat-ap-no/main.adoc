...
*** The code list, https://w3id.org/demo-resources/demo-models#demoCodelist11["Demo Code List 1"], is our "Demo classification 1" demonstrated in our link:/showroom/xkos-ap-no[showroom with demo classifications].
